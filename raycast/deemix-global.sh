...
# Documentation:
# @raycast.description Resolve any Spotify or Deezer URL and download via Deemix
...
# Call the Global Resolver script
# If no argument provided, it will use clipboard
"$DEEMIXKIT_PATH/global/global-resolver.sh" "$1"
