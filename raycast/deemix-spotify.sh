...
# Documentation:
# @raycast.description Search Spotify for an album and download via Deemix
...
# Call the Spotify to Deemix script
"$DEEMIXKIT_PATH/spotify/spotify-to-deemix.sh" "$1" "$2"
