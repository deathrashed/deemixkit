...
# @raycast.title Deemix - Text File
...
# Documentation:
# @raycast.description Download multiple albums from a text file
...
# Call the Batch Downloader script
"$DEEMIXKIT_PATH/batch/batch-downloader.sh" "${ARGS[@]}"
